<!DOCTYPE html>
<html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="/backend/assets/" data-template="vertical-menu-template-free">
  <head>
    <meta charset="utf-8" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">Venus Med</span>
            </a>
            <a href="#" class="layout- menu-link text-large ms-auto d-block d-xl-none">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <input type="text" class="form-control border-0 shadow-none ps-1 ps-sm-2" placeholder="Qidiruv..." aria-label="Qidiruv..." />
                </div>
              </div>
                  ...
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      @if (Auth::user()->photo === Null)
                          <img src="/backend/user.png" class="w-px-40 h-auto rounded-circle" width="40px">
                      @else
                          <img src="/userPhotos/{{Auth::user()->photo}}"  class="w-px-35 h-auto rounded-circle" >
                      @endif
                    </div>
                  </a>
                      ...
                      <a class a="dropdown-item" href="#" >
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            <div class="avatar avatar-online">
                              @if (Auth::user()->photo === Null)
                                  <img src="/backend/user.png" class="w-px-40 h-auto rounded-circle">
                              @else
                                  <img src="/userPhotos/{{Auth::user()->photo}}"  class="w-px-40 h-auto rounded-circle">
                              @endif
                            </div>
                          </div>
                          <div class="flex-grow-1">
                            <span style='text-transform: uppercase;' class="fw-medium d-block" >{{ Auth::user()->name }}</span>
          ...
          <footer class="content-footer footer bg-footer-theme">
            <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
              <div class="mb-2 mb-md-0">
               Copyrighted by the Venus Team © <script>document.write(new Date().getFullYear());</script>
              </div>
            </div>
          </footer>
...
<script>
    const currentRoute = '/home'; // Change this to the actual current route
    console.log(`Current Route: ${currentRoute}`);
    
    const menuItem = document.querySelector(`.menu-item a[href="${currentRoute}"]`);
    if (menuItem) {
        console.log(`Found matching menu item: ${menuItem.href}`);
